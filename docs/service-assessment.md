...
| Performance   | A+    | Lighthouse 100, LCP 0.6-0.7 s, CLS 0-0.002, TBT 0 ms (2026-09-24). CI enforces perf 100, LCP <= 2.5 s, JS <= 10 KB, total <= 150 KB, no third-party or font requests. |
